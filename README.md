...
* Organized branches, if applicable.
* Clear contribution history from all team members.
* Secure handling of credentials and secret values.
* Properly configured dependencies.
* Correctly linked frontend assets.
* Correctly linked backend services.
* Working database migrations.
* Successful frontend build.
* Successful backend execution.
* Automated tests for the main system components.

### Important

All team members must contribute through Git commits.

The commit history should clearly reflect the contribution of each student.

Each team member should use their own GitHub account and Git identity when making commits.

Repositories with an unclear contribution history may be questioned during the project defense.

The final repository should build and run successfully.

All dependencies, assets, environment variables, database services, and external integrations must be correctly linked and documented.

The README instructions should allow evaluators to reproduce and run the project successfully.
...
* The AI chat works correctly.
* Products are displayed correctly.
* Orders can be created.
* Product stock is updated.
* Order tracking works.
* Complaints and support tickets work.
* Confirmation emails work.
* Automated tests pass.
* No passwords or secret values exist in the repository.
* All team members have visible contributions in the Git history.

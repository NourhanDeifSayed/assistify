...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='assistify'),
...
META_BUSINESS_ACCOUNT_ID = config('META_BUSINESS_ACCOUNT_ID', default='')

SHOPIFY_API_KEY = config('SHOPIFY_API_KEY', default='')
SHOPIFY_API_PASSWORD = config('SHOPIFY_API_PASSWORD', default='')
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'assistify.log',
        },
    },
    'root': {
        'handlers': ['file'],
